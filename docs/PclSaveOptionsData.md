...
**rasterizeTransformedElements** | **Boolean** | Gets or sets a value determining whether or not complex transformed elements should be rasterized before saving to PCL document.  Default is true. |  [optional]
