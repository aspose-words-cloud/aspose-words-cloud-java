...
**allCaps** | **Boolean** | True if the font is formatted as all capital letters.              |  [optional]
**bidi** | **Boolean** | Specifies whether the contents of this run shall have right-to-left characteristics.              |  [optional]
**bold** | **Boolean** | True if the font is formatted as bold.              |  [optional]
**boldBi** | **Boolean** | True if the right-to-left text is formatted as bold.              |  [optional]
...
**complexScript** | **Boolean** | Specifies whether the contents of this run shall be treated as complex script text regardless of their Unicode character values when determining the formatting for this run.              |  [optional]
**doubleStrikeThrough** | **Boolean** | True if the font is formatted as double strikethrough text.              |  [optional]
**emboss** | **Boolean** | True if the font is formatted as embossed.              |  [optional]
**engrave** | **Boolean** | True if the font is formatted as engraved.              |  [optional]
**hidden** | **Boolean** | True if the font is formatted as hidden text.              |  [optional]
**highlightColor** | [**XmlColor**](XmlColor.md) | Gets or sets the highlight (marker) color.              |  [optional]
**italic** | **Boolean** | True if the font is formatted as italic.              |  [optional]
**italicBi** | **Boolean** | True if the right-to-left text is formatted as italic.              |  [optional]
**kerning** | **Double** | Gets or sets the font size at which kerning starts.              |  [optional]
**localeId** | **Integer** | Gets or sets the locale identifier (language) of the formatted characters.              |  [optional]
**localeIdBi** | **Integer** | Gets or sets the locale identifier (language) of the formatted right-to-left characters.              |  [optional]
**localeIdFarEast** | **Integer** | Gets or sets the locale identifier (language) of the formatted Asian characters.              |  [optional]
...
**noProofing** | **Boolean** | True when the formatted characters are not to be spell checked. |  [optional]
**outline** | **Boolean** | True if the font is formatted as outline.              |  [optional]
...
**scaling** | **Integer** | Gets or sets character width scaling in percent.              |  [optional]
**shadow** | **Boolean** | True if the font is formatted as shadowed.              |  [optional]
...
**smallCaps** | **Boolean** | True if the font is formatted as small capital letters.              |  [optional]
**spacing** | **Double** | Returns or sets the spacing (in points) between characters.              |  [optional]
**strikeThrough** | **Boolean** | True if the font is formatted as strikethrough text.              |  [optional]
