    ...
    try {
	   stage('0:build android sdk image') {
		if (params.StartFromStep.toInteger() < 1) {
		    checkout([$class: 'GitSCM', branches: [[name: '*/android']], doGenerateSubmoduleConfigurations: false, extensions: [], submoduleCfg: [], userRemoteConfigs: [[credentialsId: '9d6c4dfa-042c-4ed1-81c7-9175179dddda', url: 'https://git.auckland.dynabic.com/words-cloud/words-cloud-java.git']]])
