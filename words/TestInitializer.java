...
public final class TestInitializer {
    ...
    public static void UploadFile(String file, String path) throws FileNotFoundException, ApiException {
        UploadFileRequest request = new UploadFileRequest(new File(file), path);
